...
public sealed partial class NanoChatUiFragmentPirate : BoxContainer
{
    ...
    private const float GalleryPreviewMaxWidth = 248f;
    ...
    private void EnsureSelectedGalleryPhoto()
    {
        ...
        _selectedGalleryPhotoFileName = _photos.Keys.OrderBy(name => name).FirstOrDefault();
    }
    ...
    private void UpdateGalleryPreview()
    {
        ...
        GalleryPreviewName.Text = hasSelectedPhoto
            ? $"DEBUG TITLE: {selectedPhoto.FileName}"
            : "DEBUG TITLE: NO PHOTO";
        GalleryPreviewName.ToolTip = hasSelectedPhoto ? selectedPhoto.FileName : "DEBUG TITLE: NO PHOTO";
    ...
    private void UpdateAttachmentIndicator()
    {
        ...
        AttachmentLabel.Text = hasAttachment
            ? Loc.GetString("nano-chat-attached-photo", ("fileName", _attachedPhotoFileName!))
            : string.Empty;
    }
    ...
    private void ApplyGalleryPreviewTexture(Texture? texture)
    {
        ...
        {
            GalleryPreviewImage.SetSize = new Vector2(GalleryPreviewMaxWidth, GalleryPreviewMaxWidth);
            return;
        }

        var scale = GalleryPreviewMaxWidth / width;
        GalleryPreviewImage.SetSize = new Vector2(GalleryPreviewMaxWidth, height * scale);
    }
