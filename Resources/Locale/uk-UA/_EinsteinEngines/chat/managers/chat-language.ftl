...
chat-language-Psychomantic-name = Психомантика
...
chat-language-NovuNederic-name = Ново-недерландська
chat-language-TauCetiBasic-name = Базова
chat-language-Tradeband-name = Торгова
chat-language-Freespeak-name = Вільна
...
chat-language-Sign-name = Жестова
...
chat-language-Shadowmind-name = Тіньовий розум
...
chat-language-Crab-name = Крабова
chat-language-Deer-name = Олень
chat-language-Dog-name = Собача
chat-language-Duck-name = Качина
chat-language-Eldritch-name = Потойбічна
