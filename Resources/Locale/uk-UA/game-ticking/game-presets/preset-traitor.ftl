...
traitor-role-moreinfo = Знайдіть більше інформації про вашу роль у меню персонажа.
traitor-role-nouplink = На жаль, у вас немає доступу до чорного ринку.
traitor-role-allegiances = Ваші прихильності:
traitor-role-notes = Нотатки від вашого роботодавця:
traitor-role-uplink-pen-code = Прокрутіть ручку до комбінації [color = lightgray]{$code}[/color], щоб розблокувати ваш аплінк.
    Градуси позначають кути обертання. Аплінк автоматично блокується при закритті.
traitor-role-uplink-pen-code-short = Ваш код ручки-аплінку — {$code}. Прокрутіть ручку, щоб розблокувати. Блокується при закритті.
