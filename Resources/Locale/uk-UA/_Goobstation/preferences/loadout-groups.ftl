...
loadout-group-ntr-head = Головний убір представника NT
loadout-group-ntr-backpack = Рюкзак представника NT
loadout-group-ntr-neck = Аксесуар на шию представника NT
...
loadout-group-bso-mask = Маска офіцера СЩ
...
loadout-group-nct-outerclothing = Верхній одяг кар'єрного тренера NT
